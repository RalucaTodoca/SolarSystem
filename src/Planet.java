...
public class Planet extends SpaceObject{
	...
	/**
	 * Constructor pentru planeta (basic features: planet's radius, planet's orbit radius and tilt.)
	 * @param radius
	 * @param orbitRadius
	 * @param axisTilt
	 */
	...
	/**
	 * Constructor pentru planeta cu inele (basic features: planet's radius, planet's orbit radius and tilt.)
	...
	/**
	 * Desenează planetele pe baza caracteristicilor, texturii și umbririi sale
	 */
	public void draw(){
